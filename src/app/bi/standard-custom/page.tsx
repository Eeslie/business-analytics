...
import { LayoutDashboard, Sidebar } from "lucide-react"; // --- FIX: Added for the menu icon
import { SidebarContent, SidebarHeader, SidebarInset, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarProvider, SidebarTrigger } from "../../../components/ui/sidebar";
...
export default function StandardCustomReportsPage() {
  ...
  // --- FIX ---
  // The entire page is now wrapped in <SidebarProvider>
  // The <Sidebar> component holds your navigation
  // Your original page content is placed inside <SidebarInset>
  return (
    <SidebarProvider className="!bg-white">
      {/* This is the actual sidebar navigation panel */}
      <Sidebar>
        <SidebarHeader>
        ...
        <SidebarContent>
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton isActive={true} tooltip="Reports">
                <LayoutDashboard />
                <span>Standard Reports</span>
              </SidebarMenuButton>
            </SidebarMenuItem>
            {/* You can add more <SidebarMenuItem> here */}
          </SidebarMenu>
        </SidebarContent>
      </Sidebar>
      <SidebarInset>
